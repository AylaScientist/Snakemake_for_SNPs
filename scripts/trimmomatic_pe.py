...
shell(
    "java -XX:ParallelGCThreads={threads} {java_opts} -jar /data/bin/miniconda2/envs/trimmomatic-v038/share/trimmomatic-0.38-1/trimmomatic.jar PE "#"-threads {threads} {java_opts} "#"{extra} "
    "-phred64 "
    "-validatePairs "
	"./{input_r1} "
    "./{input_r2} "
